...
export function FunctionDashboard({
  ...
  const kpiCards = [
    ...
    { label: "% supportive", value: `${kpis.pctSupportive}%`, color: tokens.colorStatusSuccessForeground1, tip: "Share of your function's stakeholders whose current sentiment is supportive." },
  ];
